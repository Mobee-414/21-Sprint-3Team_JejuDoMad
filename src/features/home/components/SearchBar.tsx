    ...
    >
      <div className="flex gap-[12px]">
        ...
        <Input
          ...
          className="h-full flex-1 cursor-text border-0 p-0 text-[14px] font-medium tracking-[-0.025em] text-[#1b1b1d] shadow-none placeholder:text-[16px] placeholder:font-medium placeholder:tracking-[-0.025em] placeholder:text-[#84858C] focus-visible:ring-0 md:text-[18px] md:placeholder:text-[18px]"
        />
      </div>
